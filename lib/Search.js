...
module.exports = function (opt) {
  return new Promise((resolve, reject) => {
    ...
    let url = 'https://www.aliexpress.com/wholesale?catId=0&initiative_id=SB_20170201171227&SearchText=' + encodeURIComponent(keyword) +`&minPrice=${opt.min}&maxPrice=${opt.max}`
    if (opt && opt.page)
      url += '&page=' + opt.page
